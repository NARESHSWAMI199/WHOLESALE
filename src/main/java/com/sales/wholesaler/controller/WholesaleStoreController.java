...
public class WholesaleStoreController {
    ...
    public ResponseEntity<Map<String, String>> updateStoreNotification(@RequestBody StoreCreationRequest storeCreationRequest) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
        ...
        return new ResponseEntity<>(Map.of("message", ConstantResponseKeys.SUCCESS), HttpStatus.valueOf(200));
    }
